...
@section('content')
    ...
    <section class="calculator-section" id="calculator">
        <div class="container">
            <h2 class="section-title">Рассчитать стоимость</h2>
                    ...
                    <form id="calculatorForm" data-calculate-url="{{ route('calculator.calculate') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="volume-control">
                                ...
                                <input type="number" name="volume" id="volumeInput" class="form-control volume-input"
                                    value="10" min="0.5" max="1000" step="0.5">
    ...
    <section class="prices-section" id="prices">
        <div class="container">
            <h2 class="section-title">Цены на бетон</h2>
            <!-- Здесь ваш код с ценами -->
        </div>
    </section>

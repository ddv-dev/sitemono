<section class="py-40 bg-cream">
    <div class="container">
        ...
        <form class="contact-form js-order-form" action="{{ route('orders.store') }}" method="POST"
            data-success-text="Сообщение отправлено! Мы свяжемся с вами в ближайшее время.">
            @csrf
            <input type="hidden" name="source" value="Форма связи — Контакты">
